...
public class ArrayTest01 {
	...
	public static void main(String[] args) {
		// 배열은 같은 데이터형의 변수를 여러 개 선언할 때 필요하다.
		// 배열은 한 번 생성되면 크기를 변경할 수 없다.
		
		// 배열의 선언 (1차원 배열)
		int[] data; //메모리 할당
		int num[] = new int[5]; // 정수:0, 실수:0.0, 논리형:false 메모리가 할당됨
		...
		for(int i=0; i<data2.length; i++) {
			System.out.println("dara2["+i+"]= "+data2[i]);
		}
		
		// 배열 생성 시 초기값 설정하는 방법 2
