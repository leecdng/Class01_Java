...
//					timeBtn.setEnabled(false);
	...
	public void selectTime() {
		...
		// 검사 예약일 경우
		rsvTxt.setText(year+"년 "+month+"월 "+rsvDate+"일 "+rsvTime+"에 "+center_name+"에서 코로나 검사 예정입니다.");
	}
	...
	public void selectTime(String vc_type) {
		...
		// 백신 예약일 경우
		rsvTxt.setText(year+"년 "+month+"월 "+rsvDate+"일 "+rsvTime+"에 "+center_name+"에서 "+vc_type+" 백신 예방 접종 예정입니다.");
	}
