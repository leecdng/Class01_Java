	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			if( c>=48 && c<=57 || evtTxt.equals(".")) {
				if(evtTxt.equals(".") && totalTxt.length()==0) {
					totalTxt = "0" + evtTxt;
				} else {
				...
				System.exit(0);
			} else if(evtTxt.equals("=") || evtTxt.equals("+") || evtTxt.equals("-") || evtTxt.equals("/") || evtTxt.equals("*")) {
				if(oper.equals("+")) {
					oper=evtTxt;
					result= result + Double.parseDouble(totalTxt);
					lbl.setText(result+"");
				} else if(oper.equals("-")) {
					oper=evtTxt;
					result= result - Double.parseDouble(totalTxt);
